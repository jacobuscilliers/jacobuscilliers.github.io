...
date: 2026-04-20
description: "What it takes to move evidence-based policy from inside government."
draft: false
tags: ['education', 'South Africa', 'policy', 'RCTs']
---

Even if you ARE government, evidence-based policy change is hard. It takes strategy, patience, and courage.

That is my takeaway from a recent CSAE panel where Nompumelelo (Mpumi) Mohohlwane, the new Director for Reading at South Africa's Department of Basic Education (DBE), described their approach to evidence-based policy change. I have had the privilege of collaborating with researchers at the DBE for over a decade, iteratively experimenting with ways to improve foundational literacy in South Africa. Working with committed, smart people inside government has shaped how I think about evidence and policy.

*Stephen Taylor, who led the research unit at the DBE throughout this work, also shared reflections for this post — I draw on and quote him below.*

## The research

The starting point was the Early Grade Reading Study (EGRS), an evaluation of a structured pedagogy program, led by Stephen Taylor, Director of the Research, Monitoring, and Evaluation unit at the DBE. Teachers received detailed lesson plans and graded reading materials for home-language literacy instruction. In the [first experiment](https://jhr.uwpress.org/content/early/2019/02/04/jhr.55.3.0618-9538R1.abstract), we compared teacher training alone with training combined with on-site coaching. Coaching was about twice as effective as training alone, at similar cost — and the coaching effect was estimated much more precisely. But on-site coaching was still not scalable by government.

That raised an obvious next question: can coaching be delivered more cheaply? In a [follow-up experiment](https://voxdev.org/topic/education/virtual-coaching-teachers-less-effective-person-coaching-evidence-south-africa), we compared in-person coaching with virtual coaching delivered by phone. Unfortunately, only in-person coaching worked; the cheaper alternative had no impact. We have since run another experiment exploring whether coaching can be provided by school-based government employees rather than external experts. Limited success so far (more soon).

We have not yet cracked the scalability puzzle in South Africa. Each time, the more resource-intensive version turned out to be the most cost-effective. A central challenge, as Stephen puts it, is that scaling requires "a broad enough and unified enough political and technical leadership to drive home the reform". That kind of reform is deeply systemic — incorporating coaching into government, for example, would require changing the promotion and performance criteria of civil servants."
